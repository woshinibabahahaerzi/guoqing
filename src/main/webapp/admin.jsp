	...
	<script type="text/javascript">
        window.onload=function(){
            ...
            changeUser = function(operate , flag){
                switch (operate) {
                    case "remove":window.location="${pageContext.request.contextPath}/delete.do?username="+username;break;
                    case "changeStatu":window.location="${pageContext.request.contextPath}/update.do?username="+username+"&status="+status;break;
        ...
        function selectUser(username){
            ...
            $.ajax({
                url:"${pageContext.request.contextPath}/selectOneInfo.do",
                type:"GET",
				...
				<div class="collapse navbar-collapse"
					...
					<ul class="nav navbar-nav navbar-right">
						<li class="dropdown"><a href="#" class="dropdown-toggle"
												data-toggle="dropdown" role="button" aria-expanded="false">管理员[${sessionScope.login.username}]
			...
			<div class="table-responsive">
				<div class="row">
					...
					<div class="col-md-3 form-group ">
						<form class="form-inline" action="${pageContext.request.contextPath}/selectByname.do" method="post" id="form1">
						...
						<form action="${pageContext.request.contextPath}/add.do" method="post">
							<table  class="table-condensed">
								...
								<tr>
									...
									<td><select required="required" class="form-control" name="form">
				...
				<div class="form-group col-md-12 collapse" id="updateUserForm">
					<div class="well">
						...
						<table class="table-condensed " style="text-align: center;">
							...
							<form id="ff"   class="" action="${pageContext.request.contextPath}/updateInfo.do" method="get" >
								<tbody>
								<tr id="updateTr">
									<td><input required="required" id="username"
											   class="form-control" type="text"
											   aria-describedby="inputGroupSuccess1Status"
											   readonly="readonly" value="${requestScope.user.username}" name="username"/>
									</td>
									<td><input required="required" id="phone"
											   class="form-control" type="text"
											   aria-describedby="inputGroupSuccess1Status"
											   placeholder="请输入联系电话" name="phone" value="${requestScope.user.phone}" size="11"/></td>
									<td><input required="required" id="email"
											   class="form-control" type="text"
											   aria-describedby="inputGroupSuccess1Status"
											   placeholder="请输入邮箱" name="email" value="${requestScope.user.email}" size="25"/></td>
