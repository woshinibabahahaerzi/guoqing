	...
	<div class="container-fluid">
		...
		<tr >
			<td align="center" valign="middle">
			    <form id="form" action="${pageContext.request.contextPath}/regist.do" method="post">
				<table align="center" width="381px" height="70%" cellspacing="0" >
					...
					<tr>
						<td >用户来源</td>
						<td align="center">
							<select name="form"  style="size:20px;width:200px">
			...
			<tr><td><span style="color: red">${requestScope.message}</span></td></tr>
		</table>
